            ...
            <div class="flex">
                <div class="w-1/6">
                    <div class="flex flex-col w-64 h-full px-4 py-8 bg-blue-50 border-r">
                        <h2 class="text-center text-3xl font-semibold text-gray-800">Comtas</h2>
                        ...
                        <div class="flex flex-col justify-between flex-1 mt-6">
                            <nav>
                                ...
                                href="/">
                                    ...
                                    <span class="mx-4 font-medium">タスク一覧</span>
                                </a>
                                ...
                                href="/tickets">
                                    ...
                                    <span class="mx-4 font-medium">チケット一覧</span>
                                </a>
                                ...
                                href="/tickets">
                                    ...
                                    <span class="mx-4 font-medium">タイムライン</span>
                                </a>
                                ...
                                href="/tasks/create">
                                    <span>-</span>
                                    <span class="mx-4 font-medium">タスク追加</span>
                                </a>
                                <a class="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-200 transform rounded-md hover:bg-blue-300 hover:text-gray-700"
                                href="/tickets/create">
                                    <span>-</span>
